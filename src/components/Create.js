...
class Create extends Component{
  ...
  clickSave() {
    const { isim, soyisim, tel, yas, boy, kilo, cinsiyet, email, password, sigara, day, month, year, sigarasay, sigarapara } = this.props;
    this.props.userCreate({ isim, soyisim, tel, yas, boy, kilo, cinsiyet, email, password, sigara, day, month, year, sigarasay, sigarapara });
  }
  renderButton() {
  ...
  clickCigarette = () => {
    if (this.state.cigarette) {
      ...
      this.props.userChange({ props: 'sigara', value: '' })
    }
    else {
      this.setState({ cigarette: true, dis1: 'flex' })
      this.props.userChange({ props: 'sigara', value: 'Evet' })
    }
  }
  clickSmoke = () => {
    if (this.state.smoke) 
